...
@RestController
@RequestMapping("v1/api/hinh-anh-san-pham")
...
public class HinhAnhSanPhamController {
    ...
    public HinhAnhSanPham updateHinhAnhSanPham(@RequestBody HinhAnhSanPham hinhAnhSanPhamUpdate,@PathVariable String ma) {
